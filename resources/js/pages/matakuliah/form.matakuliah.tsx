                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Masukkan kode mata kuliah" {...field} value={String(field.value || '')} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <Button type="button" variant="outline" onClick={() => router.visit(route('master-data.matakuliah.index'))}>
                                        Batal
                                    </Button>
                                </div>
                            </form>
